            ...
            if item["contentType"] == "learn_chapter":
                ...
                for data in item["content"]:
                    ...
                    if title == "" or id == "" or Type == "" or description == "":
                        df_negative_results.loc[len(df_negative_results)] = home_data + ["", Type, id, title,section_name, "", subject,subject_tagged, "",""]

                        df_negative_results.to_csv("negative_learn_results.csv", index=False)
                    else:
                        df_positive_results.loc[len(df_positive_results)] = home_data + ["", Type, id, title,section_name, "", subject,subject_tagged, "",""]
